package org.feathercore.util.chat;
...
public enum EnumChatFormatting {
    ...
    private final static Set<Character> usedFormattingCodes = new HashSet<>();

    static {
        for(EnumChatFormatting format : values())
            usedFormattingCodes.add(format.formattingCode);
    }
