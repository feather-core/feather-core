...
import org.feathercore.util.chat.*;
...
public interface ChatComponent extends Iterable<ChatComponent> {
     ...
     */
    ChatComponent appendSibling(ChatComponent component);
    ...
    public static class Serializer implements JsonDeserializer<ChatComponent>, JsonSerializer<ChatComponent> {
        ...
        public ChatComponent deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            if (p_deserialize_1_.isJsonPrimitive()) {
                ...
                if (jsonobject.has("text")) {
                    ichatcomponent = new TextComponent(jsonobject.get("text").getAsString());
                    ...
                    if (jsonobject.has("with")) {
                        ...
                        ichatcomponent = new TranslatableComponent(s, aobject);
                    } else {
                        ichatcomponent = new TranslatableComponent(s, new Object[0]);
                    }
                    ...
                    ichatcomponent = new ScoreComponent(JsonUtils.getString(jsonobject1, "name"), JsonUtils.getString(jsonobject1, "objective"));

                    if (jsonobject1.has("value")) {
                        ((ScoreComponent) ichatcomponent).setValue(JsonUtils.getString(jsonobject1, "value"));
                    }
                } else {
                    ...
                    ichatcomponent = new SelectorComponent(JsonUtils.getString(jsonobject, "selector"));
                }
        ...
        public JsonElement serialize(ChatComponent p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_) {
            if (p_serialize_1_ instanceof TextComponent && p_serialize_1_.getChatStyle().isEmpty() && p_serialize_1_.getSiblings().isEmpty()) {
                return new JsonPrimitive(((TextComponent) p_serialize_1_).getChatComponentText_TextValue());
            } else {
                ...
                if (!p_serialize_1_.getSiblings().isEmpty()) {
                    ...
                    for (ChatComponent ichatcomponent : p_serialize_1_.getSiblings()) {
                ...
                if (p_serialize_1_ instanceof TextComponent) {
                    jsonobject.addProperty("text", ((TextComponent) p_serialize_1_).getChatComponentText_TextValue());
                } else if (p_serialize_1_ instanceof TranslatableComponent) {
                    TranslatableComponent chatcomponenttranslation = (TranslatableComponent) p_serialize_1_;
                ...
                } else if (p_serialize_1_ instanceof ScoreComponent) {
                    ScoreComponent chatcomponentscore = (ScoreComponent) p_serialize_1_;
                    ...
                    if (!(p_serialize_1_ instanceof SelectorComponent)) {
                        throw new IllegalArgumentException("Don\'t know how to serialize " + p_serialize_1_ + " as a Component");
                    }

                    SelectorComponent chatcomponentselector = (SelectorComponent) p_serialize_1_;
